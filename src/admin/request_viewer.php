        ...
        <div id="container">
            ...
            <div id='content'>
                <table class="admintable">
                    <tr><th>Referral</th><th>Bonus Amount</th><th>Account Number</th><th>Date of Request</th><th>Payment Deadline</th></tr>
                    <?php
                    ...
                    while ($row = $res->fetch_assoc()) {
                        ...
                        echo "<tr><td><button onclick=window.open('ref_viewer.php?username=".$row['vref_username']."','View','status=no')>".$row['vref_username']."</button></td><td>NGN".number_format($row['fbonus_amt'],2)."</td><td>".$row['vaccnum']."</td><td>".$row['ddateofreq']."</td><td>".$row['ddeadline']."</td></tr>";
                    }
                    ?>
                </table>
            </div>
